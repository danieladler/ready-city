...
describe HomeAssessmentController, type: :controller do
  describe "POST #update_home" do
    ...
    context "with valid params" do
      # TODO: figure out why the POST request isn't actually made.
      # binding.pry shows that 'home' isn't actually updated with the values
      # passed in via params – why?
      
      # before do
      #   post :update_home, params: { is_house: true, floor_count: 3 }
      # end
      #
      # it "redirects to User's show/profile view" do
      #   expect(response).to redirect_to "user/show"
      # end
